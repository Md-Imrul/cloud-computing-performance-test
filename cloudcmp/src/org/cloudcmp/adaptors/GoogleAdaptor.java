...
public class GoogleAdaptor extends Adaptor {
	...
	public GoogleAdaptor() {
		super();
		String computePrice = ConfigUtil.getInstance().getUnitPrice(ConfigUtil.GOOGLE_LINUX_COMPUTE_MICRO);
//		configs.put("compute_dollar_per_hour", "0.1");
		configs.put("compute_dollar_per_hour", computePrice);
	...
	public double getComputeCost() {
		...
		System.out.println("cpuSeconds: " + cpuSeconds);
...
//    	QuotaService qs = QuotaServiceFactory.getQuotaService();
//    	long s = qs.getCpuTimeInMegaCycles();
//    	long p = 0;
//    	for (int i = 0; i < 1000000; i++) {
//			p++;
//		}
//    	long e = qs.getCpuTimeInMegaCycles();
//    	double cpuSec = qs.convertMegacyclesToCpuSeconds(e-s);
//    	System.out.println(s);
//    	System.out.println(e);
//    	System.out.println(qs.getApiTimeInMegaCycles());
////    	System.out.println(cpuSec);
//    }
}

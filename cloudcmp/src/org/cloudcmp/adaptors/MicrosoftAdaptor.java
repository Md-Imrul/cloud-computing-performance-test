...
public class MicrosoftAdaptor extends Adaptor {
	...
	public MicrosoftAdaptor() {
		super();
		String computePrice = ConfigUtil.getInstance().getUnitPrice(ConfigUtil.MICROSOFT_LINUX_COMPUTE_MICRO);
...
//		configs.put("compute_dollar_per_hour", "0.12"); // price of the default instance
		...
		configs.put("azure_account_name", "ccsimplestorage1");
		configs.put("azure_account_key","rExNtPZU0vIfdlbwVLJ03GYx9Qz6/M6VkdEMxXZp56GM/O2NM2h7gUjF14skmzZ4emnCS+moCPZ9PZfLLMSObQ==");
	}

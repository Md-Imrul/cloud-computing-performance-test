...
public class AmazonAdaptor extends Adaptor {
	...
	public AmazonAdaptor() {
		...
		String computePrice = ConfigUtil.getInstance().getUnitPrice(ConfigUtil.AMAZON_LINUX_COMPUTE_MICRO);
...
//		configs.put("compute_dollar_per_hour", "0.085"); // price of the default "small" instance
		...
		configs.put("access_key_id", "AKIAIP3IM7UDIZM5ZWIA");
		configs.put("secret_access_key", "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");
	}
